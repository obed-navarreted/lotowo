...
describe('NationalDrawsPage', () => {
  ...
  it('uses calendar dates and sends Nicaragua date-times when creating a draw', () => {
    ...
    component.salesCloseDate = '2026-08-09';
    component.salesCloseTime = '18:00';
    component.save();
    ...
    expect(request.request.body.salesCloseAt).toBe('2026-08-10T00:00:00.000Z');
    request.flush({
      id: 'draw-id',
      ...
      salesCloseAt: '2026-08-10T00:00:00.000Z',
      status: 'SCHEDULED',
      salesEnabled: true,
      salesBlockedAt: null,
      winningNumber: null,
